...
TF_TOKEN_CLASSIFICATION_SAMPLE = r"""
    Example::
        ...
        >>> inputs["labels"] = tf.reshape(tf.constant([1] * tf.size(input_ids).numpy()), (-1, tf.size(input_ids))) # bs1
...
TF_MASKED_LM_SAMPLE = r"""
    Example::
        ...
        >>> input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # bs 1
...
def url_to_filename(url, etag=None):
    ...
    (see https://github.com/tensorflow/tensorflow/blob/00fad90125b18b80fe054de1055770cfb8fe4ba3/tensorflow/python/keras/
        engine/network.py#L1380)
    """
